...
Route::middleware(['auth'])->prefix('user')->group(function () {
    ...
    Route::get('/biodata', [UserController::class, 'biodata'])->name('user.biodata.edit')->middleware('auth');
...
Route::middleware(['auth'])->prefix('technician')->group(function () {
            ...
            //Route::get('/dashboard', 'technician.dashboard')->name('technician.dashboard');
            Route::get('/dashboard', function () { 
                return view('technician.dashboard');
                });
            Route::get('/tasks', function () { 
                return view('technician.task');
                });
