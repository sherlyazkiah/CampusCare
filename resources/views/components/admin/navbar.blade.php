      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <a href="https://flowbite.com" class="flex ms-2 md:me-14">
            ...
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">CampusCare</span>
          </a>
          <!-- Search -->
        ...
        <!-- Theme & Profile -->
          <p>Halo, <span class="font-semibold text-blue-600">{{ Auth::user()->username }}</span></p>
<p>Role Anda: <span class="font-semibold text-green-600">{{ Auth::user()->role->name }}</span></p>
