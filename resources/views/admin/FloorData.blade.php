                            ...
                            @forelse ($rooms as $room)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button"
                                            class="edit-room-btn inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-yellow-400 rounded-lg hover:bg-yellow-500"
                                        ...
                                        <form action="{{ route('rooms.destroy', $room->room_id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus ruangan ini?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            @empty
