@extends('layouts.app')
@section('content')
            <div class="p-14 m-40 mr-60 ml-60 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                ...
                <form action="#">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="flex justify-end col-span-6 sm:col-full">
                            <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="submit">Save</button>
                        </div>
                    </div>
                </form>
            </div>
