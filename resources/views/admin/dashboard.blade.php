...
<div class="flex gap-4">
    <!-- Card 1 -->
    <div class="w-full sm:w-1/2 lg:w-1/4 bg-white rounded-lg shadow-sm p-4 md:p-6">
        <div class="flex items-center">
        <div class="p-3 rounded-lg bg-red-100 flex items-center justify-center me-3">
            <svg class="w-6 h-6 text-red-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 19">
            <path d="M14.5 0A3.987 3.987 0 0 0 11 2.1a4.977 4.977 0 0 1 3.9 5.858A3.989 3.989 0 0 0 14.5 0ZM9 13h2a4 4 0 0 1 4 4v2H5v-2a4 4 0 0 1 4-4Z"/>
            <path d="M5 19h10v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2ZM5 7a5.008 5.008 0 0 1 4-4.9 3.988 3.988 0 1 0-3.9 5.859A4.974 4.974 0 0 1 5 7Zm5 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm5-1h-.424a5.016 5.016 0 0 1-1.942 2.232A6.007 6.007 0 0 1 17 17h2a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5ZM5.424 9H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h2a6.007 6.007 0 0 1 4.366-5.768A5.016 5.016 0 0 1 5.424 9Z"/>
            </svg>
        </div>
        <div class="ml-2">
            <h5 class="mb-1 leading-none text-2xl font-bold text-gray-900 pb-1">10</h5>
            <p class="text-sm font-normal text-gray-500">Damage Report</p>
        </div>
        </div>
    </div>
    <!-- Card 2 -->
    <div class="w-full sm:w-1/2 lg:w-1/4 bg-white rounded-lg shadow-sm p-4 md:p-6">
        <div class="flex items-center">
        <div class="p-3 rounded-lg bg-yellow-100 flex items-center justify-center me-3">
            <svg class="w-6 h-6 text-yellow-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 19">
            <path d="M14.5 0A3.987 3.987 0 0 0 11 2.1a4.977 4.977 0 0 1 3.9 5.858A3.989 3.989 0 0 0 14.5 0ZM9 13h2a4 4 0 0 1 4 4v2H5v-2a4 4 0 0 1 4-4Z"/>
            <path d="M5 19h10v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2ZM5 7a5.008 5.008 0 0 1 4-4.9 3.988 3.988 0 1 0-3.9 5.859A4.974 4.974 0 0 1 5 7Zm5 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm5-1h-.424a5.016 5.016 0 0 1-1.942 2.232A6.007 6.007 0 0 1 17 17h2a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5ZM5.424 9H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h2a6.007 6.007 0 0 1 4.366-5.768A5.016 5.016 0 0 1 5.424 9Z"/>
            </svg>
        </div>
        <div class="ml-2">
            <h5 class="mb-1 leading-none text-2xl font-bold text-gray-900 pb-1">5</h5>
            <p class="text-sm font-normal text-gray-500">Request Received</p>
        </div>
        </div>
    </div>
    <!-- Card 3 -->
    <div class="w-full sm:w-1/2 lg:w-1/4 bg-white rounded-lg shadow-sm p-4 md:p-6">
        <div class="flex items-center">
        <div class="p-3 rounded-lg bg-green-100 flex items-center justify-center me-3">
            <svg class="w-6 h-6 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 19">
            <path d="M14.5 0A3.987 3.987 0 0 0 11 2.1a4.977 4.977 0 0 1 3.9 5.858A3.989 3.989 0 0 0 14.5 0ZM9 13h2a4 4 0 0 1 4 4v2H5v-2a4 4 0 0 1 4-4Z"/>
            <path d="M5 19h10v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2ZM5 7a5.008 5.008 0 0 1 4-4.9 3.988 3.988 0 1 0-3.9 5.859A4.974 4.974 0 0 1 5 7Zm5 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm5-1h-.424a5.016 5.016 0 0 1-1.942 2.232A6.007 6.007 0 0 1 17 17h2a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5ZM5.424 9H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h2a6.007 6.007 0 0 1 4.366-5.768A5.016 5.016 0 0 1 5.424 9Z"/>
            </svg>
        </div>
        <div class="ml-2">
            <h5 class="mb-1 leading-none text-2xl font-bold text-gray-900 pb-1">8</h5>
            <p class="text-sm font-normal text-gray-500">In Progress</p>
        </div>
        </div>
    </div>
    <!-- Card 4 -->
    <div class="w-full sm:w-1/2 lg:w-1/4 bg-white rounded-lg shadow-sm p-4 md:p-6">
        <div class="flex items-center">
        <div class="p-3 rounded-lg bg-blue-100 flex items-center justify-center me-3">
        ...
        <div class="ml-2">
            <h5 class="mb-1 leading-none text-2xl font-bold text-gray-900 pb-1">20</h5>
            <p class="text-sm font-normal text-gray-500">Repaired</p>
        </div>
        </div>
    </div>
</div>
...
<!-- Chart -->
<div class="flex gap-4">
  <div class="mt-5 w-full sm:w-4/4 lg:w-3/4 bg-white rounded-lg shadow-sm p-4 md:p-6">
    <div class="flex justify-between mb-5">
      <div class="grid gap-4 grid-cols-2">
        <div>
          <h5 class="inline-flex items-center text-gray-500 leading-none font-normal mb-2">Damage</h5>
          <p class="text-gray-900 text-2xl leading-none font-bold">10</p>
        </div>
        <div>
          <h5 class="inline-flex items-center text-gray-500 leading-none font-normal mb-2">Repaired</h5>
          <p class="text-gray-900 text-2xl leading-none font-bold">20</p>
        </div>
      </div>
      <div>
  ...
  <!-- Rating -->
<div class="mt-5 w-full sm:w-1/2 lg:w-1/4 bg-white rounded-lg shadow-sm p-4 md:p-6">
  <h3 class="mb-2 text-xl font-bold text-gray-900">Rating</h3>

  
  <!-- Donut Chart -->
  <div id="rating-donut-chart" class="mb-2"></div>
  <p class="text-center text-md font-medium text-gray-500">4.80 / 5.00</p>
  <p class="text-center text-sm font-medium text-gray-500">from 25 user ratings</p>
  <div class="pl-10">
...
<!-- Table -->
<div class="mt-5 p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6">
      <!-- Card header -->
      <div class="items-center justify-between lg:flex">
        <div class="mb-4 lg:mb-0">
          <h3 class="mb-2 text-xl font-bold text-gray-900">Report</h3>
          <span class="text-base font-normal text-gray-500">This is a list of latest report</span>
        </div>
      </div>
      <!-- Table -->
                ...
                <tbody class="bg-white">
                  <tr>
                    ...
                    <td class="p-4 whitespace-nowrap">
                      <span class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-green-100">Repaired</span>
                    </td>
                  </tr>
                  <tr class="bg-gray-50">
                    <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap">
                  ...
                  <tr>
                    ...
                    <td class="p-4 whitespace-nowrap">
                      <span class="bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-red-100">Cancelled</span>
                    </td>
                  </tr>
                  <tr class="bg-gray-50">
                    <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap">
