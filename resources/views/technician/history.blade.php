    ...
    <div id="detail-report-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <form class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="flex justify-end space-x-3 rtl:space-x-reverse border-t border-gray-200 rounded-b dark:border-gray-600">
                </div>
                <div>
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            <h1 class="text-l font-semibold text-gray-900 dark:text-white">Completion Report</h1>
                        </div>
                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Photo</label>
                            <img src="your-photo-url.jpg" alt="Completion Photo" class="rounded-lg w-full max-h-64 object-contain border border-gray-300 dark:border-gray-600">
                        </div>
                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                            <textarea readonly rows="4" class="border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">The projector working properly.</textarea>
                        </div>
                    </div>
                </div>
            </div>
