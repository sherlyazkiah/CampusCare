                                    ...
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="p-4 whitespace-nowrap">
                                            ...
                                            @elseif ($status === 'In Progress')
                                                <span
                                                    class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-md border border-blue-200 dark:bg-gray-700 dark:border-blue-300 dark:text-blue-300">
                                                    In Progress
                                                </span>
                                            @elseif ($status === 'Done')
                                                <span
        ...
        : 'N/A';
                                        ...
                                        @if($report->image_path)
                                            <div class="col-span-6">
                                                ...
                                                <img src="{{ asset($report->image_path) }}" alt="Reported Facility"
