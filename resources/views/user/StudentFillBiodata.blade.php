...
<div class="p-4 m-40 mr-60 ml-60 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    <h3 class="text-center mb-10 text-xl font-semibold dark:text-white">Student Biodata</h3>
    ...
    <form action="{{ route('student.biodata.store') }}" method="POST">
        @csrf
        <div class="grid grid-cols-6 gap-6">
            ...
            {{-- NIM --}}
<div class="col-span-6 sm:col-span-3">
    <label for="identity" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NIM</label>
