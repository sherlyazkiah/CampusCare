...
@section('main')
    <div class="px-4 py-8 mt-14 sm:ml-64 text-black dark:text-white bg-white dark:bg-gray-900">
                    ...
                    <div class="overflow-hidden shadow sm:rounded-lg">
                        <table id="selection-table" class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                            ...
                            <tbody class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                @forelse ($reports as $report)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="p-4 space-x-2 whitespace-nowrap">
                                            ...
                                            <button type="button" data-modal-target="delete-report-modal"
                                                data-modal-toggle="delete-report-modal"
                                            ...
                                            <button type="button" data-modal-target="feedback-report-modal"
                                    ...
                                    <!-- Detail Report Modal -->
                                    <div id="detailModal{{ $report->damage_report_id }}"
                                        class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
                                        <div
                                            class="bg-white rounded-lg shadow-lg max-w-4xl w-full p-6 relative dark:bg-gray-800">
                                            <div class="flex justify-between items-center mb-4">
                                                <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Report Detail
                                                </h2>
                                                <button onclick="closeModal('detailModal{{ $report->damage_report_id }}')"
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                                <div>
                                                    <label
                                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">Reporter</label>
                                                    <input type="text" readonly value="{{ $report->user->username ?? '-' }}"
                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100 text-gray-800 dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                                                </div>
                                                <div>
                                                    <label
                                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">Title</label>
                                                    <input type="text" readonly value="{{ $report->reporter->title ?? 'N/A' }}"
                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100 text-gray-800 dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" readonly
                                                        value="{{ $report->facility->facility_name ?? 'N/A' }}"
                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                                                </div>
                                                <div>
                                                    <label
                                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">Location</label>
                                                    <input type="text" readonly
                                                        value="{{ $report->room->room_name ?? 'N/A' }}, {{ $report->floor->floor_name ?? '' }}"
                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                                                </div>
                                                ...
                                                <div>
                                                    <label
                                                        ...
                                                        & Time</label>
                                                    <input type="text" readonly
                                                        value="{{ $report->created_at->format('M d, Y H:i') }}"
                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                                                </div>
                                                <div>
                                                    <label
                                                        ...
                                                        Level</label>
                                                    <input type="text" readonly value="{{ $report->c1 }}"
                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <textarea readonly rows="3"
                                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ $report->description }}</textarea>
                                            </div>
                                            ...
                                            @if($report->image_path)
                                                <div class="mb-6">
                                                    ...
                                                    <img src="{{ asset('storage/' . $report->image_path) }}" alt="Reported Facility"
                                                        class="mt-2 rounded border max-h-64 object-contain shadow" />
                                                </div>
                                            @endif
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="p-4 text-sm text-center text-gray-500 dark:text-gray-400">No
                                            reports found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        <!-- Delete Report Modal -->
        <div id="delete-report-modal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <div class="flex justify-end p-2">
                        <button type="button"
                            ...
                            data-modal-hide="delete-report-modal">
