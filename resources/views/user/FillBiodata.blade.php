...
<div class="p-4 m-40 mr-60 ml-60 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    <h3 class="text-center mb-10 text-xl font-semibold dark:text-white">User Biodata</h3>
...
<div class="col-span-6 sm:col-span-3">
    ...
    <select name="title" id="title" required
        ...
        <option value="Dosen" {{ old('title') == 'Dosen' ? 'selected' : '' }}>Dosen</option>
        <option value="Mahasiswa" {{ old('title') == 'Mahasiswa' ? 'selected' : '' }}>Mahasiswa</option>
        <option value="Tendik" {{ old('title') == 'Tendik' ? 'selected' : '' }}>Tendik</option>
    </select>
</div>
