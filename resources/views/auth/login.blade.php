...
<body class="bg-white dark:bg-gray-900">
    ...
    <div class="md:w-1/2 flex justify-center mb-8 md:mb-0">
        <img src="{{ asset('login.svg') }}" alt="Illustration" class="h-[35rem]">
    </div>
    <!-- Login Form -->
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:w-1/2 md:h-screen">
        ...
        <div class="w-full bg-white rounded-lg dark:border sm:max-w-xl dark:bg-gray-800 dark:border-gray-700">
            <div class="p-8 space-y-4 md:space-y-6 sm:p-8">
                ...
                @if ($errors->any())
                    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                        <strong>Whoops!</strong> Ada masalah dengan input kamu:
